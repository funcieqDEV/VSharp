...
namespace VSharp
{
    ...
    public class Parser(List<Token> tokens)
    {
        ...
        private UseStatement ParseUse()
        {
             ...
             */
            Consume(TokenType.KeywordUse, "");
            var name = ParseExpression();
            Consume(TokenType.KeywordAs, "Expected 'as'");


            
            var NameSpace = Consume(TokenType.Identifier, "Expected identifiter.");
